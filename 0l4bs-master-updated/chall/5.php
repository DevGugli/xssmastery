<?php
if (!isset($_COOKIE['xssmasterkey'])) {
	setcookie('xssmasterkey', 'xssmasterkey', time() + (86400 * 30), "/",null,null,true);
	header("Refresh:0");
}
?>
<!DOCTYPE html>
...
if (isset($_COOKIE['xssmasterkey'])) {
    ...
    echo "<br><span style=\"font-size:1em;\">Current value supplied by <b>xssmasterkey</b> cookie is: </span><br>" . (string)$_COOKIE['xssmasterkey'] . '';
