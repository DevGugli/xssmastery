...
<script>
if (localStorage.getItem("labs-xssmastery") === null) {
	 localStorage.setItem("labs-xssmastery", "labs-xssmastery");
}
</script>
  </head>
  <body>
      ...
      <div class="columns">
        <div class="column is-3 is-flex">
          <div class="column-child sidebar shadow">
            ...
            <img src="../chall/img/xss-master-labs.png" width="200px" />             
...
<!-- partial -->
  ...
  <script>
if (localStorage.getItem("xssmasterkey") !== null) {
		 document.getElementById("content").innerHTML = "<span>Current value of <b>labs-xssmastery</b> LocalStorage is: </span>" + localStorage.getItem("xssmasterkey") + "";
}
</script>
</body>
</html>
