...
header('Location:'.$_SERVER['PHP_SELF'].'?'.'status=xssmastery');
die;
}
?>
<!DOCTYPE html>
      ...
      <div class="columns">
        <div class="column is-3 is-flex">
          <div class="column-child sidebar shadow">
            ...
            <div class="photo"><img src="img/logo.png" href="/XSSMASTRY/index.html" width="250px"/></div>
...
?>    
                   <br>
                <span class="success">Happy</span> <span class="directory">hacking</span> <span class="user-input" id="userInput"></span>
              </div>
            </div>
            <br>
