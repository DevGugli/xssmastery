<?php
if (!isset($_COOKIE['labs-xssmastery'])) {
	setcookie('labs-xssmastery', 'labs-xssmastery', time() + (86400 * 30), "/",null,null,true);
	header("Refresh:0");
}
?>
<!DOCTYPE html>
          ...
          <div class="column-child sidebar shadow">
            ...
            <h5>Cross-site scripting labs for web application security enthusiasts</h5>
              <div class="social-icons">
                <a><i class="fab fa-facebook icon"></i></a>
                <a><i class="fab fa-github icon"></i></a>
            ...
            <div class="terminal-window primary-bg" onclick="document.getElementById('dummyKeyboard').focus();">
              <div class="terminal-output" id="terminalOutput">
                <div class="terminal-line">
                  <span class="help-msg">Chall 4 — Clue : <span class="code">Cookie</span> </span>
                </div>
              </div>
...
if (isset($_COOKIE['labs-xssmastery'])) {
    ...
    echo "<br><span style=\"font-size:1em;\">Current value supplied by <b>labs-xssmastery</b> cookie is: </span><br>" . (string)$_COOKIE['labs-xssmastery'] . '';
