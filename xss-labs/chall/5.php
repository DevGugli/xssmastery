...
if(isset($_POST['username'])) {
  if(isset($userinfo[$_POST['username']])){if($userinfo[$_POST['username']] == $_POST['password']) {
    ...
    header('Location: 5.php?message=wrong user name or password');

  }

}else{header('Location: 5.php?message=wrong user name or password');}
...
<html>
  <head>
  <meta charset="UTF-8">
  <title>XSS Labs | XSSMASTERY</title>
  <meta charset="utf-8">
  ...
  <div class="hero-body">
          ...
          <div class="column-child sidebar shadow">
            ...
            <h5>Cross-site scripting labs for web application security enthusiasts</h5>
              <div class="social-icons">
                <a href="https://fb.me/xssmastery"><i class="fab fa-facebook icon"></i></a>
                <a href="https://github.com/xssmastery"><i class="fab fa-github icon"></i></a>
                <a href="https://ig.me/xssmastery"><i class="fab fa-instagram icon"></i></a>
              </div>
        ...
        <div class="column is-flex">
          <div class="column-child terminal shadow">
            <div class="terminal-bar dark-mode">
              ...
              <div class="terminal-bar-text is-hidden-mobile dark-mode-text">enigma@xssmastery: ~</div>
            </div>
    ...
    if(isset($_SESSION['username'])){
      ...
      echo '<br><br><a class="siimple-btn siimple-btn--blue" href="javascript:delete_cookie(\'PHPSESSID\');" >Logout</a>';
			...
			echo '<form name="myForm" action="5.php"  method="post">
			<div class="siimple-form">
			<span class="help-msg">Chall 5 — Clue : <span class="code">Login Page</span> </span>
			<br><br>
...
<span class="success">Happy</span> <span class="directory">hacking ^_^</span> <span class="user-input" id="userInput"></span>
  ...
  <footer class="footer">
    ...
    <p>
        Support by <i class="fas fa-heart icon"></i> XSSMASTERY.
      </p>
    </div>
  </footer>
</section>
