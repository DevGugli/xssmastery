            ...
            <div class="terminal-window primary-bg" onclick="document.getElementById('dummyKeyboard').focus();">
              <div class="terminal-output" id="terminalOutput">
                <div class="terminal-line">
                  <span class="help-msg">Chall 11 — Clue : <span class="code">Regex Filter #2</span> </span>
                </div>
              </div>
              <div class="terminal-line">
...
xecscrip|addimpor)t|(?:fromcharcod|cooki)e|innerhtml)|\@import)\b)/', '', $name);
			...
			echo '<form name="myForm" action="11.php" onsubmit="return validateForm()" method="post">
			<div class="siimple-form">
			<div class="siimple-form-title">Send a comment</div>
			<div class="siimple-form-field">
				<input type="text" class="siimple-input siimple-input--fluid" placeholder="xssmastery" name="fname">
			</div>
			<div class="siimple-form-field">
